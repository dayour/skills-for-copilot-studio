...
Inject the current date into agent instructions using Power Fx so the orchestrator can accurately interpret relative timeframes.
...
_Tags: `date`, `time`, `Power Fx`, `instructions`, `orchestrator`, `scheduling`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/date-context.md)
