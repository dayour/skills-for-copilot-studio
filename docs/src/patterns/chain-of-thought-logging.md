...
Send high-level "Thinking" messages during multi-step orchestration to improve observability and perceived responsiveness.
...
_Tags: `chain-of-thought`, `CoT`, `AutomaticTaskInput`, `reasoning-trace`, `observability`, `thinking-messages`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/chain-of-thought-logging.md)
