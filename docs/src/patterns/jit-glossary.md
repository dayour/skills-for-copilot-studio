...
Load customer-specific acronyms into a global variable on first message so the orchestrator can expand them before searching knowledge sources.
...
_Tags: `knowledge`, `glossary`, `acronyms`, `initialization`, `JIT`, `OnActivity`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/jit-glossary.md)
