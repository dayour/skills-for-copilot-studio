---
sidebar_position: 11
title: "Line Breaks in Messages"
---
# Line Breaks in Messages

<span class="pattern-status-badge status-proven">Proven</span>

Use `<br /><br />` inside message and question nodes to render reliable paragraph spacing across channels.
...
_Tags: `formatting`, `line-breaks`, `SendActivity`, `Question`, `paragraph-spacing`, `br-tag`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/line-breaks-in-messages.md)
