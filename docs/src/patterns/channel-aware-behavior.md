---
sidebar_position: 3
title: "Channel-Aware Behavior"
---
# Channel-Aware Behavior

<span class="pattern-status-badge status-experimental">Experimental</span>

Detect the host channel (Teams, M365 Copilot, web chat, Direct Line, etc.) from System.Activity.ChannelId and gate behavior per surface.
...
_Tags: `channels`, `Teams`, `M365 Copilot`, `Direct Line`, `web chat`, `Activity`, `ChannelId`, `conditional`, `Power Fx`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/channel-aware-behavior.md)
