---
sidebar_position: 15
title: "RAI Error Handling"
---
# RAI Error Handling

<span class="pattern-status-badge status-recommended">Recommended</span>

Classify Azure OpenAI content-filter errors in OnError and return category-specific user messages with telemetry.
...
_Tags: `OnError`, `ContentFiltered`, `RAI`, `content-filter`, `Azure-OpenAI`, `AI-Builder`, `OpenAIViolence`, `OpenAIHate`, `OpenAISelfHarm`, `OpenAIJailBreak`, `OpenAIndirectAttack`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/rai-error-handling.md)
