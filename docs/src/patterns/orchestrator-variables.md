---
sidebar_position: 12
title: "Orchestrator-Generated Variables"
---
# Orchestrator-Generated Variables

<span class="pattern-status-badge status-proven">Proven</span>

Use AutomaticTaskInput to have the orchestrator classify or extract structured data from the user's message at topic selection time — zero extra cost or latency.
...
_Tags: `orchestrator`, `classification`, `extraction`, `AutomaticTaskInput`, `knowledge-routing`, `variables`_

---

[View source / edit on GitHub](https://github.com/microsoft/skills-for-copilot-studio/blob/main/patterns/orchestrator-variables.md)
